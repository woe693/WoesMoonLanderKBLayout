...
combo_t keyCombos[COMBO_COUNT] = {
    [NAV_LAYER] = COMBO_ACTION(NAV_combo),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        KC_EQL,     KC_1,            KC_2,           KC_3,        KC_4,     KC_5,    XXXXXXX,                    KC_RGHT,  KC_6,      KC_7,             KC_8,             KC_9,             KC_0,             KC_MINS,
        KC_DEL,     KC_Q,            KC_W,           KC_E,        KC_R,     KC_T,    XXXXXXX,                    TG(SYMB), KC_Y,      KC_U,             KC_I,             KC_O,             KC_P,             KC_BSLS,
        KC_BSPC,    KC_A,            KC_S,           KC_D,        KC_F,     KC_G,    XXXXXXX,                    KC_MEH,   KC_H,      KC_J,             KC_K,             KC_L,             LT(MDIA,KC_SCLN), LGUI_T(KC_QUOT),
        KC_LSFT,    LCTL_T(KC_Z),    KC_X,           KC_C,        KC_V,     KC_B,                                          KC_N,      KC_M,             KC_COMM,          KC_DOT,           RCTL_T(KC_SLSH),  KC_RSFT,
        XXXXXXX,    XXXXXXX,         XXXXXXX,        XXXXXXX,     XXXXXXX,           XXXXXXX,                    XXXXXXX,             KC_UP,            KC_DOWN,          KC_LBRC,          KC_RBRC,          MO(SYMB),
